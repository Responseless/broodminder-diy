...
##
## Responseless Mon, May 6, 2024
## Cleanup code and fix errors with libraries, new py version etc.
...
def extractData(deviceId, data):
    ...
    temperatureDegreesC = (float(temperatureDegreesC) - 5000) / 100  # new
    ...
    print("Model = {}", int(byte(data, byteNumAdvdeviceModelIFllc_1), 16))
    ...
    if (weightScaledTotal > -1):
        ...
        print("Sample = {}, Weight = {}, TemperatureC = {}, Humidity = {}, Battery = {}".format(sampleNumber, weightScaledTotal, temperatureDegreesC, humidityPercent, batteryPercent))
        # Send the info to MyBroodMinder.com
#        print ("Sending device '" + deviceId + "' data to the MyBroodMinder Cloud ...")
#        url_string = "https://mybroodminder.com/api_public/devices/upload?device_id=" + deviceId + "&sample=" + str(sampleNumber) + "&temperature=" + str(temperatureDegreesF) + "&humidity=" + str(humidityPercent) + "&weight=" + str(weightScaledTotal) + "&battery_charge=" + str(batteryPercent)
#        print (url_string)

#        contents = urllib2.urlopen(url_string).read()
    else:
        # We do not have a valid weight.
        print("Sample = {}, TemperatureC = {}, Humidity = {}, Battery = {}".format(sampleNumber, temperatureDegreesC, humidityPercent, batteryPercent))
        # Send the info to MyBroodMinder.com
  #      print ("Sending device '" + deviceId + "' data to the MyBroodMinder Cloud ...")
  #      url_string = "https://mybroodminder.com/api_public/devices/upload?device_id=" + deviceId + "&sample=" + str(sampleNumber) + "&temperature=" + str(temperatureDegreesF) + "&humidity=" + str(humidityPercent) + "&battery_charge=" + str(batteryPercent)
  #      print (url_string)
